...
export default function Search() {
  ...
  return (
    <div className='flex flex-col md:flex-row'>
      <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen w-[530px]'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
          ...
          <div className='flex gap-2 flex-wrap items-center'>
            ...
            <div className='flex gap-2'>
              <input type='checkbox' id='sale' className='w-5' onChange={handleChange} value={sidebardata.type==='sale'}/>
              <span>Sale</span>
            </div>
            <div className='flex gap-2'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <select
              onChange={handleChange} defaultValue={'created_at_desc'} id='sort_order' className='border rounded-lg p-3'
            >
